...
# from torch._six import container_abcs # torch 1.8
import collections.abc # torch 2.0
...
def to_2tuple(x):
    ...
    if isinstance(x, collections.abc.Iterable): # torch 2.0
        return x
...
class VisionTransformer(nn.Module):
    ...
    def init_weights(self, pretrained=None, cfg_for_init=None):
        ...
        if not self.random_init:
            ...
            if self.model_name in ['vit_small_patch16_224', 'vit_base_patch16_224']:
                load_pretrained(self, cfg_for_init, num_classes=self.num_classes, in_chans=self.in_chans, pos_embed_interp=self.pos_embed_interp,
